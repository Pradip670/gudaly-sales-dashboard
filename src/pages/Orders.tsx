...
import { Plus, Search, Eye, Trash2, ShoppingCart, Minus, FileText } from 'lucide-react';
    ...
    <div className="page-container space-y-6">
      ...
      <Dialog open={isInvoiceOpen} onOpenChange={setIsInvoiceOpen}>
        <DialogContent className="sm:max-w-2xl">
          <DialogHeader>
            <DialogTitle>Invoice {viewingOrder?.invoiceNumber}</DialogTitle>
          </DialogHeader>
          {viewingOrder && (
            <div className="space-y-6">
              ...
              <div className="flex justify-between">
                <div>
                  <h3 className="font-semibold text-lg">Gudaly Chocolates</h3>
                  <p className="text-sm text-muted-foreground">Premium Chocolate Distributor</p>
                </div>
                <div className="text-right">
                  <p className="font-mono text-sm">{viewingOrder.invoiceNumber}</p>
